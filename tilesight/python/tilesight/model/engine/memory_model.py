...
from tilesight.model.engine.cache_sim import SimResult
from tilesight.model.engine.cache_sim import simulate as _simulate
...
def buffer_residency(cur_gpu_config: HardwareSpec, footprint_bytes: float, klass: str) -> float:
    ...
    from tilesight.model.kernels.gemm import resident_frac
