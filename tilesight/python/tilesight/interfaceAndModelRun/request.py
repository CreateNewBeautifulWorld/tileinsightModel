...
from tilesight.model.memory import GB, kv_bytes_per_seq_all
from tilesight.interfaceAndModelRun.run_config import RunConfig
from tilesight.interfaceAndModelRun.runner import ModelReport, run_model
...
def request_summary(r: RequestReport) -> str:
    from tilesight.generateResult.report.table import bound_report
    rc = r.rc
