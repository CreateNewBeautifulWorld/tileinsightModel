...
from tilesight.gpuTilingPerfHWModel.model.memory import GB, kv_bytes_per_seq_all
from tilesight.gpuTilingPerfHWModel.interfaceAndRun.run_config import RunConfig
from tilesight.gpuTilingPerfHWModel.interfaceAndRun.runner import ModelReport, run_model
...
def request_summary(r: RequestReport) -> str:
    from tilesight.gpuTilingPerfHWModel.genResult.table import bound_report
    rc = r.rc
