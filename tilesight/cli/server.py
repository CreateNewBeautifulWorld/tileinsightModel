...
from tilesight.gpuTilingPerfHWModel.genResult.timeline import cycle_csv, machine_timeline, steady_timeline, trace_text
from tilesight.gpuTilingPerfHWModel.interfaceAndRun.request import request_summary
...
def _top_kernels(rep, cur_gpu_config, n: int = 3):
    ...
    from tilesight.gpuTilingPerfHWModel.interfaceAndRun.runner import resolve_op
    out = []
